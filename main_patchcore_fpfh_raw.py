...
def run(
    ...
    result_collect = []
    root_dir = './data'
    save_root_dir = './benchmark/patchcore_fpfh_raw/'
    print('Task start: Patchcore FPFH Raw')
    ...
    for dataset_count, dataset_name in enumerate(real_3d_classes):
        ...
        with device_context:
            ...
            scores_fpfh, segmentations_fpfh, labels_gt_fpfh, masks_gt_fpfh = PatchCore.predict_fpfh(
                test_loader
            )
