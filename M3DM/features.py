...
from M3DM.pointnet2_utils import interpolating_points
from M3DM.feature_fusion import FeatureFusionBlock

from M3DM.models import Model,Model1
...
class Features1(torch.nn.Module):
    ...
    def calculate_metrics(self):
        ...
        self.image_rocauc = roc_auc_score(self.image_labels, self.image_preds)
        self.pixel_rocauc = roc_auc_score(self.pixel_labels, self.pixel_preds)
        self.image_ap = average_precision_score(self.image_labels, self.image_preds)
        self.pixel_ap = average_precision_score(self.pixel_labels, self.pixel_preds)
        # self.au_pro, _ = calculate_au_pro(self.gts, self.predictions)
